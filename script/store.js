        ...
        <li class="border-radius-8 bg-white mb-8 shadow-sm">
          ...
          <div class="py-4 px-6 ">
            ...
            <p class="text-xl pb-2">
              <i class="bi bi-telephone pe-3"></i>${item.phone}
            </p>
            <p class="text-xl pb-2">
              <i class="bi bi-clock pe-3"></i>${item.hours}
            </p>
            <p class="text-xl">
              <i class="bi bi-geo-alt pe-3"></i>${item.address}
            </p>
          </div>
          <a class="bg-black text-center text-white py-4 block" href="${item.link}">詳細資訊</a>
        </li>
    `;
}
